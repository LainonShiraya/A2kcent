...
import "../oferts_companies/ofert_companies.css";
const Oferts_companies = () => {
  return (
    <div className="ofertsCompanies-container">
      <div className="ofertsCompanies-title-container">
        <h1 className="header-title-companies">Firmy</h1>
        <h2 className="sub-title-companies">
          Dla Kadry Zarządzającej oraz pracowników Firm
        </h2>
      </div>
      <div className="ofertsCompanies-text-container">
        {/* <span>
        ...
        <span>
          ...
          wyglądu etykiety oraz wprowadzimy ewentualne poprawki. <br /> <br />{" "}
          <span className="text-bolded text-color-green">
            {" "}
            Wdrożenia i konsultacje{" "}
          </span>{" "}
          ...
          przesłanych informacji. oceny opisu i wyglądu etykiety oraz
          wprowadzimy ewentualne poprawki. Pomożemy w opracowaniu prawidłowych
          etykiet dla środków spożywczych - w oparciu o aktualne normy i
          wymagania UE opracujemy etykiety dla środków spożywczych i suplementów
          diety oraz przygotujemy poprawne tabele wartości odżywczych. Pomożemy
          w przygotowaniu dokumentacji do wprowadzenia produktu na rynek.
          Współpracujący z nami ekspert od wielu lat zajmuje się prawem
          żywnościowym i na bieżąco monitoruje dynamicznie zmieniające się
          przepisy w tym zakresie. <br /> <br /> Ponadto zapraszamy do
          uczestnictwa w{" "}
          <span className="text-bolded text-color-green">
...
export default Oferts_companies;
