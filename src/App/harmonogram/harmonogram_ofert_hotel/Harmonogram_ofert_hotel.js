  ...
  const dodajOsobe = () => {
    ...
    if (compDate1.getTime() > compDate2.getTime()) {
      ...
      if (emailRegex.test(Email)) {
        ...
        setOsoby([
          ...osoby,
          { Id, Imie, Nazwisko, Email, telefon, hotelDateStart, hotelDateEnd },
        ]);
        ...
        <div className="harmonogram-regulamin">
          ...
          <div className="harmonogram-bulletpoints">
            ...
            <h6>
              ...
              zgłoszeniowej na adres Centrum Naukowo-Techniczne A2K CeNT s.c.
              ul. Opinogórska 2 lok.69, 04-039 Warszawa
            </h6>
            <h6>
            ...
            <h6>
              ...
              odpowiedzialności w przypadku, gdy karta zgłoszeniowa wysłana
              Pocztą Polską lub innym doręczycielem, nie dotrze do Centrum
            ...
            <h6>
              ...
              terminem szkolenia uczestnik szkolenia otrzymuje od Organizatora,
              na podany w karcie zgłoszeniowej adres mailowy, informację
              dotyczącą statusu szkolenia (czy się odbywa czy też nie) oraz w
              przypadku potwierdzenia organizacji szkolenia szczegółowe
              informacje na jego temat – program, godziny i zaproszenie na
              szkolenie w formie linku.
              <span className="bold">
                {" "}
            ...
            <h6>
              <span className="bold">
                ...
                oprogramowaniem Webex. Zajmie to 5-10 minut. Dopiero po tym
                teście otrzymają Państwo link do szkolenia.
              </span>
            </h6>
            <h6>
              6. W przypadku stwierdzenia przez Państwa braku takiej informacji
              w terminie 4 dni roboczych przed planowanym terminem szkolenia,
            ...
            <h6>
              7. Zastrzegamy sobie prawo do zmiany terminu i wykładowcy z
              powodów losowych. O takiej sytuacji będą Państwo informowani drogą
              mailową i/lub telefoniczną.
            </h6>
            <h6>
            ...
            <h6>
              9. Wysłanie karty zgłoszeniowej jest akceptacją powyższych
              warunków współpracy.
            </h6>
            <h5>
            ...
            <h6>
              ...
              , bezpośrednio ode Państwa lub od podmiotu, który Państwa
              zatrudnia.
            </h6>
            <h6>
